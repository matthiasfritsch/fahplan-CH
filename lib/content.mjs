...
// 480 - Kopf 44 - Fussbereich 128 - Linie 2 - Innenabstand 2
export const EVENT_BUDGET = 304;
export const DAY_HEAD_H = 24;
...
export function selectEvents(events, today, nowTime, budget = EVENT_BUDGET) {
