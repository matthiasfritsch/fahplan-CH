...
/* Prioritaet: Termine von Yunas Schule vor Flohmaerkten vor dem
   Rest. Flohmaerkte erkennt die Liste am Titel, die Routine kann
   zusaetzlich "prio": true setzen. */
export function weight(e) {
  if (e.school) return 3;
  if (e.prio || /floh|brocante|troedel|tr\u00f6del/i.test(e.title || "")) return 2;
  return 1;
}
